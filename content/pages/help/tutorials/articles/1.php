...
$steps = [
    ...
    ['title' => 'Add first details'],
    ['title' => 'Learn about accounting'],
...
// ---------- HELPERS ----------
function render_tutorial_step1($text, $index, $listItems, $imgs = [], $indexes_enabled = false, $prefixes = [])
{
    echo "<div>";
...
<section class="spaced-content" id="step-1">
    <?php render_tutorial_step1("Enter basic details", 1, $workflowList); ?>
...
<section class="spaced-content" id="step-2">
    <?php
    render_tutorial_step1("Go to Workflows", 2, $workflowList, [
...
<section class="spaced-content" id="step-3">
    <?php
    render_tutorial_step1("Add first details", 3, $workflowList, [
        'https://placehold.co/600x400'
    ]);
    ?>
</section>
...
<section class="spaced-content" id="step-4">
    ...
    render_tutorial_step1("Learn about accounting", 4, $step4Text, [
        'https://placehold.co/600x400',
        'https://placehold.co/600x400',
        'https://placehold.co/600x400',
        'https://placehold.co/600x400'
...
<section class="spaced-content" id="step-5">
    <?php
    render_tutorial_step1("Try it yourself", 5, $workflowList, [
        'https://placehold.co/600x400',
        'https://placehold.co/600x400',
        'https://placehold.co/600x400'
