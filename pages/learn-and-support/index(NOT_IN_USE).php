...
//        ? load_page_content(ROOT_PATH . 'pages/learn-and-support/main/index(NOT_IN_USE).php')
//        : load_page_content(ROOT_PATH . "pages/learn-and-support/{$page_name}/index(NOT_IN_USE).php");
//
//$breadcrumbs = [
...
//?>
<!---->
<!--<div class="feature__page features__container feature__container fx-column">-->
<!--    <div class="content">-->
<!--        --><?php //if (!$isMainPage): ?>
...
<!--                    --><?php
//                    $content = load_page_content(ROOT_PATH . "pages/learn-and-support/$p/index(NOT_IN_USE).php");
//                    if ($content):
...
<!--    </div>-->
<!--</div>-->
<!--<script src="js/feature-page.js?v=--><?php //= $staticVersion ?><!--" defer></script>-->
<!--<script>-->
<!--    window.allowedPages = --><?php //= json_encode($allowed_pages) ?>//;
//    window.currentPage = 'learn-and-support';
//    window.currentSubPage = '<?php //= $current_page ?>//';
//</script>